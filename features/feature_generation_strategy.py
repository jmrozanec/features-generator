...
class DivFeatureGenerationStrategy(ColumnBasedFeatureGenerationStrategyAbstract):
    def generate(self, train, val, test, colname1, colname2):
        train[self.featurename(colname1, colname2)]=train[colname1]/(train[colname2]+1)
        val[self.featurename(colname1, colname2)]=val[colname1]/(val[colname2]+1)
        test[self.featurename(colname1, colname2)]=test[colname1]/(test[colname2]+1)
        return (train, val, test)
